...
public class OVRLipSyncContextTextureFlip : MonoBehaviour
{
    ...
    public Texture[] Textures = new Texture[LipSync.VisemeCount];
    ...
    private LipSync.Frame oldFrame = new LipSync.Frame();
    ...
    void Update ()
    {
        if((lipsyncContext != null) && (material != null))
        {
            ...
            if (frame != null)
            {
                ...
                if (lipsyncContext.provider == LipSync.ContextProviders.Original)
                {

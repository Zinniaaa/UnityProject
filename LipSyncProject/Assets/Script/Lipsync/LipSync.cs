...
public class LipSync : MonoBehaviour
{
    ...
    public static LipSync sInstance = null;
    ...
    void Awake()
    {
        if (IsInitialized() != Result.Success)
        {
            ...
            {
                Debug.LogWarning(System.String.Format("OvrLipSync Awake: Failed to init Speech Rec library"));
            }
        }
    }
    ...
    public static Result Initialize()
    {
        ...
        String str = System.String.Format("OvrLipSync Awake: Queried SampleRate: {0:F0} BufferSize: {1:F0}", sampleRate, bufferSize);
    ...
    public static Result ProcessFrame(uint context, float[] audioBuffer, Frame frame, bool stereo = true)
    {
        ...
        var rc = ovrLipSyncDll_ProcessFrameEx(context,handle.AddrOfPinnedObject(), numSamples, dataType,
